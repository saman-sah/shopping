<template>
    <div id="page-content">        
        ...
        <!--End Breadcrumbs-->
		<div class="page-title"><h1>Blog Right Sidebar</h1></div>
        <div class="container">
        	<div class="row">
                <!--Main Content-->
                <div class="col-12 col-sm-12 col-md-9 col-lg-9 main-col">
                    <div class="blog--list-view blog--grid-load-more">
                        ...
                        <div class="article"> 
                            <!-- Article Image --> 
                             <a class="article_featured-image" href="blog-single-post.html"><img class="blur-up ls-is-cached lazyloaded" data-src="assets/images/blog/870x440.jpg" src="assets/images/blog/870x440.jpg" alt="27 Days of Spring Fashion Recap"></a> 
                            <h2 class="h3"><a href="blog-right-sidebar.html">27 Days of Spring Fashion Recap</a></h2>
                            <ul class="publish-detail">                      
								<li><i class="anm anm-user-al" aria-hidden="true"></i> Posted by: Lee</li>
                                <li><i class="icon anm anm-clock-r"></i> <time datetime="2017-05-02">May 02, 2017</time></li>
                                <li><i class="icon anm anm-comments-l"></i> <a href="#"> 5 comments</a></li>
                            </ul>
                            <div class="rte"> 
                        ...
                        <div class="article"> 
                            <!-- Article Image --> 
                             <a class="article_featured-image" href="blog-single-post.html"><img class="blur-up ls-is-cached lazyloaded" data-src="assets/images/blog/870x440.jpg" src="assets/images/blog/870x440.jpg" alt="How to Wear The Folds Trend Four Ways"></a> 
                            <h2 class="h3"><a href="blog-single-post.html">How to Wear The Folds Trend Four Ways</a></h2>
                            <ul class="publish-detail">                      
                                <li><i class="anm anm-user-al" aria-hidden="true"></i> Posted by: Jhon</li>
                                <li><i class="icon anm anm-clock-r"></i> <time datetime="2017-05-02">May 02, 2017</time></li>
                            ...
                            <p><a href="blog-single-post.html" class="btn btn-secondary btn--small">Read more <i class="fa fa-caret-right" aria-hidden="true"></i></a></p>
                        </div>
                        <div class="article"> 
                            <!-- Article Image --> 
                             <a class="article_featured-image" href="blog-single-post.html"><img class="blur-up lazyload" data-src="assets/images/blog/870x440.jpg" src="assets/images/blog/870x440.jpg" alt="Accusantium doloremque"></a> 
                            <h2 class="h3"><a href="blog-single-post.html">Accusantium doloremque</a></h2>
                            <ul class="publish-detail">                      
                                <li><i class="anm anm-user-al" aria-hidden="true"></i> Posted by: Carl</li>
                                <li><i class="icon anm anm-clock-r"></i> <time datetime="2017-05-02">May 02, 2017</time></li>
                                <li><i class="icon anm anm-comments-l"></i> <a href="#"> 1 comments</a></li>
                            </ul>
                            <div class="rte"> 
						...
						<div class="article"> 
                            <!-- Article Image --> 
                            <a class="article_featured-image" href="blog-single-post.html"><img class="blur-up lazyload" data-src="assets/images/blog/870x440.jpg" src="assets/images/blog/870x440.jpg" alt=""></a> 
                            <h2 class="h3"><a href="blog-single-post.html">Consequences that are extremely painful</a></h2>
                            <ul class="publish-detail">                      
                                <li><i class="anm anm-user-al" aria-hidden="true"></i> Posted by: Lee</li>
                                <li><i class="icon anm anm-clock-r"></i> <time datetime="2017-05-02">May 02, 2017</time></li>
                                <li><i class="icon anm anm-comments-l"></i> <a href="#"> 1 comments</a></li>
						...
						<div class="article"> 
                            <!-- Article Image --> 
                            <a class="article_featured-image" href="blog-single-post.html"><img class="blur-up lazyload" data-src="assets/images/blog/870x440.jpg" src="assets/images/blog/870x440.jpg" alt=""></a> 
                            <h2 class="h3"><a href="blog-single-post.html">it look like readable English</a></h2>
                            <ul class="publish-detail">                      
                                <li><i class="anm anm-user-al" aria-hidden="true"></i> Posted by: Lee</li>
                                <li><i class="icon anm anm-clock-r"></i> <time datetime="2017-05-02">May 02, 2017</time></li>
                                <li><i class="icon anm anm-comments-l"></i> <a href="#"> 1 comments</a></li>
            	...
            	<div class="col-12 col-sm-12 col-md-3 col-lg-3 sidebar">
					<div class="sidebar_widget">
						...
						<div class="custom-search">
							<form action="/search" method="get" class="input-group search-header search" role="search" style="position: relative;">
                	...
                	<div class="sidebar_tags">
                    	<div class="sidebar_widget categories">
                            <div class="widget-title"><h2>Blog Category</h2></div>
                            <div class="widget-content">
                                <ul class="sidebar_categories">
                                	<li class="lvl-1 "><a href="/" class="site-nav lvl-1">Denim Jeans</a></li>
                                    <li class="lvl-1  active"><a href="#" class="site-nav lvl-1">Fashion</a></li>
                                    <li class="lvl-1 "><a href="#" class="site-nav lvl-1">Summer</a></li>
                                    <li class="lvl-1 "><a href="#" class="site-nav lvl-1">Trending</a></li>
							...
							<div class="widget-content">
                                <div class="list list-sidebar-products">
                                  <div class="grid">
                                      ...
                                      <div class="mini-list-item">
                                        <div class="mini-view_image">
                                            <a class="grid-view-item__link" href="#">
                                                <img class="grid-view-item__image blur-up ls-is-cached lazyloaded" data-src="assets/images/blog/post-img1.jpg" src="assets/images/blog/post-img1.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="details"> <a class="grid-view-item__title" href="#">It's all about how you wear</a>
                                          <div class="grid-view-item__meta"><span class="article__date">May 02, 2017</span></div>
                                        </div>
                                      </div>
                                    </div>
                                    <div class="grid__item">
                                      <div class="mini-list-item">
                                        <div class="mini-view_image"> <a class="grid-view-item__link" href="#"><img class="grid-view-item__image blur-up ls-is-cached lazyloaded" data-src="assets/images/blog/post-img2.jpg" src="assets/images/blog/post-img2.jpg" alt=""></a> </div>
                                    ...
                                    <div class="grid__item">
                                      <div class="mini-list-item">
                                        <div class="mini-view_image"> <a class="grid-view-item__link" href="#"><img class="grid-view-item__image blur-up ls-is-cached lazyloaded" data-src="assets/images/blog/post-img3.jpg" src="assets/images/blog/post-img3.jpg" alt=""></a> </div>
                                    ...
                                    <div class="grid__item">
                                      <div class="mini-list-item">
                                        <div class="mini-view_image"> <a class="grid-view-item__link" href="#"><img class="grid-view-item__image blur-up ls-is-cached lazyloaded" data-src="assets/images/blog/post-img6.jpg" src="assets/images/blog/post-img6.jpg" alt=""></a> </div>
